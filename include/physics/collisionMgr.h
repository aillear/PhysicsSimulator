...
class CollisionMgr {
  public:
    ...
    bool IntersectCircle(const GlmCircle& a, const GlmCircle& b, glm::vec2 &norm,
                         float &depth);
  ...
  private:
    void FindContactPoints(const GlmCircle& a, const GlmCircle& b, glm::vec2 &contactPoint);
